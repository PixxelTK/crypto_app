...
abstract class AppLocalizations {
  ...
  /// No description provided for @coinsPageTitle.
  ///
  /// In en, this message translates to:
  /// **'Coins'**
  String get coinsPageTitle;

  /// No description provided for @searchCoinsHint.
  ///
  /// In en, this message translates to:
  /// **'Search coins...'**
  String get searchCoinsHint;

  /// No description provided for @topCoinsTitle.
  ///
  /// In en, this message translates to:
  /// **'Top Coins'**
  String get topCoinsTitle;
